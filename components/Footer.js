    ...
    <div className="flex flex-wrap md:text-left text-center order-first">
      ...
      <div className="lg:w-1/3 md:w-1/2 w-full px-4">
        <nav className="list-none flex flex-col mb-10 mx-2">
          <Link href="/">
            <a className="py-2 text-gray-600 hover:text-keppel-700">Inicio</a>
          </Link >
          <Link href="/nosotros">
            <a className="py-2 text-gray-600 hover:text-keppel-700">Nosotros</a>
          </Link>
          <Link href="/servicios">
            <a className="py-2 text-gray-600 hover:text-keppel-700">Servicio</a>
          </Link>
          <Link href="/diferenciadores">
            <a className="py-2 text-gray-600 hover:text-keppel-700">Diferenciadores</a>
          </Link>
          <Link href="/experiencia">
            <a className="py-2 text-gray-600 hover:text-keppel-700">Experiencia</a>
          </Link>
          <Link href="/mas">
      ...
      <div className="lg:w-1/3 md:w-1/2 w-full px-4 items-center">
        ...
        <div className="flex xl:flex-nowrap md:flex-nowrap lg:flex-wrap flex-wrap justify-center items-end md:justify-start">
          ...
          <button className="lg:mt-2 xl:mt-0 flex-shrink-0 inline-flex text-white bg-keppel-500 border-0 py-2 px-6 focus:outline-none hover:bg-keppel-600 rounded">Suscribirse</button>
        </div>
        <p className="text-gray-700 text-sm mt-2 md:text-left text-center">Enterate de nuestra ultimas novedades
          <br className="lg:block hidden"/>y promociones en nuestros servicios
        </p>
      </div>
    </div>
  </div>
