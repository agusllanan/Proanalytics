  ...
  return (
    <Layout>
      ...
      <section 
        ...
        style={{
          backgroundImage: `url(/img/six-sigma/banner/banner-white.jpg)`,
        }}>
        <div className="py-10 px-16 justinfy-end w-1/3">
          <Image
            ...
            width="600"
            height="400"
            src='/img/six-sigma/banner/certificado-white.png' 
            className="rounded-lg self-center items-center"
            alt=""
            />
        </div>
        <div className="py-44 w-1/3 text-gray-500 space-y-5">
