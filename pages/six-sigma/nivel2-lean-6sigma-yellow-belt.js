    ...
    <Layout>
      ...
      <div className="flex sm:flex-row flex-col h-auto">
        <div className="bg-white text-center flex sm:w-1/2 w-full">
          <h3 className="mx-auto h-44 sm:py-24 sm:h-72 text-xl sm:text-4xl text-blue-500 font-bold place-self-center">
            ...
            <span className="font-bold text-keppel-500">YELLOW BELT</span>
          </h3>
        </div>
        <div className="bg-white w-full sm:w-1/2 flex justify-center items-center">
          <ul className="w-4/5 mx-auto list-disc pb-6 place-self-center my-4">
            ...
            <li className="text-scooter-500 text-lg">Datos</li>
            <li className="text-scooter-500 text-lg ml-4">
              <span className="font-bold text-keppel-500">Tamaño muestral</span>
            </li>
            <li className="text-scooter-500 text-lg ml-4">
              <span className="font-bold text-keppel-500">
            ...
            <li className="text-scooter-500 text-lg ml-4">
              <span className="font-bold text-keppel-500">Tipo de datos</span>
            </li>
            <li className="text-scooter-500 text-lg">
              <span className="font-bold text-keppel-500">Indicador OEE</span> -
      ...
      <div className="flex flex-col sm:flex-row h-48">
        ...
        <div className="w-full sm:w-1/2 flex">
          ...
          <span className="font-bold text-keppel-500">Lean 6 Sigma Yellow Belt</span> - Preferentemente haber cursado el Nivel 1, haberse acreditado anteriormente como <span className="font-bold text-keppel-500">White Belt,</span> o tener experiencia en <span className="font-bold text-keppel-500">herramientas básicas de Lean Manufacturing.</span> Perfil para personal responsable o interesado en mejoras de procesos productivos o administrativos.
          </p>
        </div>
      </div>
    </Layout>
