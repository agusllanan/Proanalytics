  ...
  return (
    <Layout>
      <div
        ...
        style={{
          backgroundImage: `url(/img/six-sigma/portadas/Portada-Six-Sigma-Green.png)`,
        }}
      >
        <div className="h-screen flex flex-col lg:flex-row lg:justify-start sm:justify-center place-items-center font-mont">
          <div className="flex flex-col lg:ml-4 container content-center bg-white shadow-2xl h-96 w-4/5 lg:w-1/4 sm:rounded-t-xl rounded-l-xl items-center self-center">
            ...
            <p className="w-4/5 mx-auto justify-center text-justify">
              ...
              <span className="font-bold text-keppel-500">Lean 6 Sigma.</span>{" "}
              Podrás desarrollarte como líder de proyectos de{" "}
              <span className="font-bold text-keppel-500">mejora continua</span>{" "}
      ...
      <div className="flex sm:flex-row flex-col h-auto">
        <div className="bg-white text-center flex sm:w-1/2 w-full">
          <h3 className="mx-auto h-44 sm:py-24 sm:h-72 text-xl sm:text-4xl text-blue-500 font-bold place-self-center">
            ...
            <span className="font-bold text-keppel-500">GREEN BELT</span>
          </h3>
        </div>
        <div className="bg-white w-full sm:w-1/2 flex justify-center items-center">
          <ul className="w-4/5 mx-auto list-disc pb-6 place-self-center my-4">
            ...
            <li className="text-scooter-500 text-lg ml-4">
              <span className="font-bold text-keppel-500">Histogramas</span>
            </li>
            <li className="text-scooter-500 text-lg ml-4">
              <span className="font-bold text-keppel-500">
                Gráficos de puntos
            ...
            <li className="text-scooter-500 text-lg ml-4">
              <span className="font-bold text-keppel-500">Correlación</span>
            </li>
            <li className="text-scooter-500 text-lg ml-4">
              <span className="font-bold text-keppel-500">Anova</span>
            </li>
            <li className="text-scooter-500 text-lg">
              <span className="font-bold text-keppel-500">
            ...
            <li className="text-scooter-500 text-lg">
              <span className="font-bold text-keppel-500">Plan de Control</span>
            </li>
            <li className="text-scooter-500 text-lg">
              <span className="font-bold text-keppel-500">AMEF</span>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div className="flex flex-col sm:flex-row h-48">
        ...
        <div className="w-full sm:w-1/2 flex">
          <p className="w-4/5 mx-auto text-regular self-center">
            ...
            anteriormente como{" "}
            <span className="font-bold text-keppel-500">Yellow Belt,</span> o
