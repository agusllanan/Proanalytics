...
export default function contactanos () {
    ...
    <div className="flex flex-col text-center w-full mb-12">
        <h1 className="sm:text-3xl text-2xl font-bold title-font mb-4 text-green-500">Contactenos</h1>
        <p className="lg:w-2/3 mx-auto leading-relaxed text-base">Estamos a su disposicion para resolver cualquier tipo de duda</p>
    </div>
    <div className="lg:w-1/2 md:w-2/3 mx-auto">
        ...
        <div className="p-2 w-full pt-8 mt-8 border-t border-gray-200 text-center">
            <a className="text-green-500">contacto@proanalytics.com</a>
            <p className="leading-normal my-5">49 Smith St.
            <br /> Saint Cloud, MN 5630
            </p>
