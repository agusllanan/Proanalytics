      ...
      >
        <div className="h-screen flex flex-col lg:flex-row lg:justify-start sm:justify-center place-items-center font-mont">
          <div className="flex flex-col lg:ml-4 container content-center bg-white shadow-2xl w-4/5 lg:w-1/3 rounded-t-xl md:rounded-tr-none md:rounded-l-xl self-center">
            <h3 className="w-4/5 mx-auto text-2xl py-8 font-bold text-scooter-500">
              NIVEL 3 - <br />
            ...
            Planea y ejecuta estrategias de manera exitosa y eficaz. Este nivel está enfocado en las <span className="font-bold text-keppel-500">herramientas que ofrece Smartsheets</span> para  crear y gestionar proyectos de forma clara, ordenada y eficiente, asignar actividades, tareas y establecer fechas objetivas.
              <br /> <br />
      ...
      <div className="flex sm:flex-row flex-col h-auto">
        <div className="bg-white text-center flex sm:w-1/2 w-full">
          <h3 className="mx-auto h-44 sm:py-24 sm:h-72 text-xl sm:text-4xl text-blue-500 font-bold place-self-center">
            LO QUE VAS A APRENDER EN EL NIVEL 3 -{" "}
            <span className="font-bold text-keppel-500">PROJECT MANAGEMENT</span>
          </h3>
        </div>
        <div className="bg-white w-full sm:w-1/2 flex justify-center items-center">
          <ul className="w-4/5 mx-auto list-disc pb-6 place-self-center my-4">
            <li className="text-scooter-500 text-lg font-bold">Menú General y Navegación</li>
            <li className="text-scooter-500 text-lg font-bold">
            Diagrama de Gantt
            </li>
            <li className="text-scooter-500 text-lg ml-4">Tareas y Predecesoras</li>
            <li className="text-scooter-500 text-lg ml-4">Asignación</li>
            <li className="text-scooter-500 text-lg ml-4">Técnicas</li>
            ...
            <li className="text-scooter-500 text-lg ml-4">Chats & Anexos</li>
            <li className="text-scooter-500 text-lg ml-4">Notificaciones</li>
            <li className="text-scooter-500 text-lg ml-4">Alertas</li>
            <li className="text-scooter-500 text-lg ml-4">Alarmas</li>
            <li className="text-scooter-500 text-lg font-bold">
            Indicadores
            </li>
            <li className="text-scooter-500 text-lg ml-4">Dashboards</li>
            <li className="text-scooter-500 text-lg ml-4">KPI’s</li>
            <li className="text-scooter-500 text-lg ml-4">Reportes</li>
          </ul>
        </div>
      </div>
      <div
