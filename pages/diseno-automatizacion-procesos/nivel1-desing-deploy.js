      ...
      >
        <div className="h-screen flex flex-col lg:flex-row lg:justify-start sm:justify-center place-items-center font-mont">
          <div className="flex flex-col lg:ml-4 container content-center bg-white shadow-2xl w-4/5 lg:w-1/3 rounded-t-xl md:rounded-tr-none md:rounded-l-xl self-center">
            ...
            Como participante tendrás conocimiento pleno de los alcances y limitaciones de la herramienta, podrás dimensionar las posibilidades de implementación en tu organización, crear nuevas hojas de trabajo, diseñar procesos y usar las herramientas de comunicación.
            <br /> <br />
      ...
      <div className="flex sm:flex-row flex-col h-auto">
        <div className="bg-white text-center flex sm:w-1/2 w-full">
          <h3 className="mx-auto h-44 sm:py-24 sm:h-72 text-xl sm:text-4xl text-blue-500 font-bold place-self-center">
            ...
            <span className="font-bold text-keppel-500">DESIGN & DEPLOY</span>
          </h3>
        </div>
        <div className="bg-white w-full sm:w-1/2 flex justify-center items-center">
          <ul className="w-4/5 mx-auto list-disc pb-6 place-self-center my-4">
            <li className="text-scooter-500 text-lg font-bold">
              Menú General y Navegación
            </li>
            <li className="text-scooter-500 text-lg font-bold">Documentos</li>
            <li className="text-scooter-500 text-lg ml-4">Hojas</li>
            <li className="text-scooter-500 text-lg ml-4">Carpetas</li>
            <li className="text-scooter-500 text-lg ml-4">Formularios</li>
            <li className="text-scooter-500 text-lg ml-4">Anexos</li>
            <li className="text-scooter-500 text-lg font-bold">Colaboración</li>
            <li className="text-scooter-500 text-lg ml-4">Chat</li>
            <li className="text-scooter-500 text-lg ml-4">Notificaciones</li>
            <li className="text-scooter-500 text-lg ml-4">Alertas</li>
            <li className="text-scooter-500 text-lg font-bold">
              Integración Inicial
            </li>
            <li className="text-scooter-500 text-lg ml-4">Vinculos</li>
            <li className="text-scooter-500 text-lg ml-4">Informes</li>
